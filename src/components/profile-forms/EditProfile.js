...
const Edit = ({
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      ruppee: loading || !profile.ruppee ? "" : profile.ruppee,
          ...
          <div style={{ height: "auto" }} class="common-form">
            <div className="form-side">
              <div className="heading-common">
                ...
                <p className="lead" style={{color:"#5680E9"}}>
                  <i className="fas fa-user"></i> Stand Out from a group of Doctors:
                </p>
              </div>
            ...
            <div className="img-side">
              <img
                src={require("../../img/editar.svg")}
                alt=""
                style={{height:"450px",paddingLeft:"10px"}} 
